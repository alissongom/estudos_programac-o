...
# só é possível fazer comparação com o str se for com o mesmo tipo de dado a comparação lexicografica
...
# Operações Com String | Operador de Acesso das Strings [indice] (o espaço também conta como caractere)
...
# Metodos das Str ( Manipulação de Str )
